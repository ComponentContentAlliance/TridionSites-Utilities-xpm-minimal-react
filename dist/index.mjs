...
var HeadlessXpmEditor = function (_a) {
    ...
    return (jsxs("div", { className: "headlessXpmRegion ".concat(className || "", " ").concat(toggleXpm || !showExpSpaceEditor ? "headlessXpmRegion-hover" : ""), style: __assign({}, containerStyle), children: [(toggleXpm || !showExpSpaceEditor) &&
