...
var HeadlessXpmEditor = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "headlessXpmRegion ".concat(toggleXpm || !showExpSpaceEditor ? "hover-enabled" : ""), style: { containerStyle: containerStyle }, children: [(toggleXpm || !showExpSpaceEditor) &&
